                ...
                <div class="card-body pt-9 pb-0">
                    ...
                    <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                        ...
                        <div class="me-7 mb-4">
                            <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                <img src="https://via.placeholder.com/400?text=Upload+Your+DP" alt="image" />
                    ...
                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="../../demo14/dist/account/settings.html">Overview</a>
                        </li>
                        {/*--end::Nav item*/}
                        {/*--begin::Nav item*/}
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5" href="../../demo14/dist/account/security.html">Security</a>
                        </li>
                        {/*--end::Nav item*/}
                        {/*--begin::Nav item*/}
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5" href="../../demo14/dist/account/billing.html">Billing</a>
                        </li>
                        {/*--end::Nav item*/}
                        {/*--begin::Nav item*/}
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5" href="../../demo14/dist/account/statements.html">Statements</a>
                        </li>
                        {/*--end::Nav item*/}
                        {/*--begin::Nav item*/}
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5" href="../../demo14/dist/account/referrals.html">Referrals</a>
                        </li>
                        {/*--end::Nav item*/}
                        {/*--begin::Nav item*/}
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5" href="../../demo14/dist/account/api-keys.html">API Keys</a>
                        </li>
                        {/*--end::Nav item*/}
                        {/*--begin::Nav item*/}
                        <li class="nav-item mt-2">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="image-input image-input-outline" data-kt-image-input="true" style={{ "background-image": " url('assets/media/svg/avatars/blank.svg')" }}>
                                        ...
                                        <div class="image-input-wrapper w-125px h-125px" style={{ "background-image": "url(https://via.placeholder.com/400?text=Upload)" }}></div>
